...
export function Wrapped({ data, year, onYearChange }: Props) {
  const slides = [
    { id: "title", component: <TitleSlide data={data} year={year ?? 0} onYearChange={onYearChange} /> },
      ...
      ? [
          {
            id: "most-used-model",
            component: (
              <MostUsedModelSlide model={data.mostUsedModel} totalSessions={data.totalStats.totalSessions} />
            ),
          },
        ]
      : []),
    ...
    ...(data.mostExpensiveSession
      ? [{ id: "most-expensive", component: <MostExpensiveSlide session={data.mostExpensiveSession} /> }]
      : []),
    ...(data.longestSession
      ? [{ id: "longest-session", component: <LongestSessionSlide session={data.longestSession} /> }]
      : []),
      ...
      ? [
          {
            id: "swearing",
            component: (
              <SwearingSlide totalSwears={data.totalStats.totalSwears} topSwear={data.totalStats.topSwear} />
            ),
          },
        ]
      : []),
      ...
      ? [
          {
            ...
            component: (
              <ProjectBreakdownSlide breakdown={data.projectBreakdown} />
            ),
          },
        ]
      : []),
